								...
								<ul class="dropdown-menu">
									...
									<li>
										<ul class="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm">
											...
											<li>
												<a href="" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
													<div class="peer mR-15"><img class="w-3r bdrs-50p" src="https://randomuser.me/api/portraits/men/3.jpg" alt="">
													</div>
													<div class="peer peer-greed">
														<span>
							...
							<li class="dropdown">
								<a href="" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-toggle="dropdown">
									<div class="peer mR-10">
										...
										<img class="w-2r bdrs-50p" src="http://localhost/deoSite/assets/img/<?php echo $row['images'];?>" alt="">
									</div>
									<div class="peer">
									...
									<li>
										<a href="" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
											...
											<form action="admin-logout.php" method="post">
									            <button class="btn btn-primary" type="submit" name="logout_btn">
									            	<i class="ti-power-off mR-10"></i>
									            	<span>Logout</span>
									            </button>
									        </form>
